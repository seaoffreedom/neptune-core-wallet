...
describe('NeptuneProcessManager - Real Tests', () => {
  ...
  beforeEach(async () => {
    ...
    (mockExeca as any).mockReturnValue(mockProcess);
  ...
  describe('Configuration Validation', () => {
    it('should validate network configuration', () => {
      const validNetworks = ['main', 'alpha', 'beta', 'testnet', 'regtest'];
    ...
    it('should handle invalid port configurations', () => {
      ...
      expect(() => new NeptuneProcessManager(invalidConfig)).not.toThrow();
    });
  });
