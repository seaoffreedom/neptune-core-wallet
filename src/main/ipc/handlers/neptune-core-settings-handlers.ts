...
export function registerNeptuneCoreSettingsHandlers(): void {
    ...
    ipcMain.handle(
        ...
        async (_event, settings: Partial<NetworkSettings>) => {
            try {
                const updated =
                    neptuneCoreSettingsService.updateNetwork(settings);
                return {
                    success: true,
                    settings: updated,
                };
    ...
    ipcMain.handle(
        ...
        async (_event, settings: Partial<MiningSettings>) => {
            try {
                const updated =
                    neptuneCoreSettingsService.updateMining(settings);
                return {
                    success: true,
                    settings: updated,
                };
    ...
    ipcMain.handle(
        ...
        async (_event, settings: Partial<PerformanceSettings>) => {
            try {
                const updated =
                    neptuneCoreSettingsService.updatePerformance(settings);
                return {
                    success: true,
                    settings: updated,
                };
    ...
    ipcMain.handle(
        ...
        async (_event, settings: Partial<SecuritySettings>) => {
            try {
                const updated =
                    neptuneCoreSettingsService.updateSecurity(settings);
                return {
                    success: true,
                    settings: updated,
                };
    ...
    ipcMain.handle(
        ...
        async (_event, settings: Partial<AdvancedSettings>) => {
            try {
                const updated =
                    neptuneCoreSettingsService.updateAdvanced(settings);
                return {
                    success: true,
                    settings: updated,
                };
    ...
    // Reset to defaults
    ipcMain.handle(
        IPC_CHANNELS.NEPTUNE_SETTINGS_RESET_TO_DEFAULTS,
        async () => {
            try {
    ...
    ipcMain.handle(
        ...
        async (_event, jsonString: string) => {
            try {
                const settings =
                    neptuneCoreSettingsService.importSettings(jsonString);
                return {
                    success: true,
                    settings,
                };
