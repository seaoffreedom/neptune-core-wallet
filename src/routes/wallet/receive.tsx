  ...
  return (
    <PageContainer>
      <div className="space-y-6">
        ...
        <ReceiveAddressCard address={address} isLoading={isLoading} />
        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
              <li>Share your receiving address with the sender</li>
              <li>Wait for the transaction to be broadcast to the network</li>
              <li>Funds will appear in your wallet once confirmed</li>
              <li>Check transaction history for confirmation status</li>
            </ul>
          </div>

          <div className="pt-4 border-t">
            <p className="text-xs text-muted-foreground">
              <strong>Note:</strong> This is a privacy-preserving address.
              Neptune uses advanced cryptography to protect your transaction
              privacy.
            </p>
          </div>
        </div>
