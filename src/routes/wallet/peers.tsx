...
function PeerManager() {
  ...
  useEffect(() => {
    ...
    if (networkSettings?.network) {
      console.log('📡 Loading peers for network:', networkSettings.network);
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your Neptune Core peer connections and banned peers. (Active:{' '}
            {activePeers.length}, Banned: {bannedPeers.length})
          </p>
        </div>
