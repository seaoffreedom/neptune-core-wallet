    ...
    try {
      ...
      const newMiningData: MiningData = {
        ...
        blockIntervals: blockIntervalsResult.success
          ...
          : [],
        cpuTemp: cpuTempResult.success ? (cpuTempResult.temp ?? null) : null,
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              {miningData?.cpuTemp && (
                <div className="mt-2">
                  <Progress
                    value={Math.min((miningData.cpuTemp / 80) * 100, 100)}
                    className="h-2"
                  />
                </div>
              )}
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {miningData?.syncStatus?.pendingTransactions || 0}
              </div>
              <p className="text-xs text-muted-foreground">In mempool</p>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {miningData?.syncStatus?.lastSyncCheck
                  ? formatTimeAgo(miningData.syncStatus.lastSyncCheck)
                  : '--'}
              </div>
