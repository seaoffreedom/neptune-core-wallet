  ...
  const settingsCategories = [
    {
      icon: Network,
      title: 'Network',
      description: 'Configure peer connections, ports, and network settings',
    ...
    },
    {
      icon: Shield,
      title: 'Security',
      description: 'Privacy controls, access management, and wallet recovery',
    ...
    },
    {
      ...
      description:
        'Configure price fetching, currency display, and market data',
      href: '/settings/price',
    },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Configure Neptune Core CLI arguments and wallet preferences. Changes
        ...
        <Card className="bg-primary/2">
          <CardHeader>
            ...
            <CardDescription className="space-y-2 text-sm">
              <p>
                These settings control neptune-core and neptune-cli command-line
                arguments. All settings are encrypted and stored locally.
              </p>
