                ...
                <Card>
                    <CardHeader>
                        ...
                        <Alert className="mt-3">
                            ...
                            <AlertDescription>
                                <strong>Role:</strong> Convert Proof Collections
                                to Single Proofs using powerful hardware (64GB+
                                RAM).
                                <br />
                                <strong>Revenue:</strong> Earn 0.05+ NPT per
                                transaction from users who need third-party
                                proof generation.
                            </AlertDescription>
                        </Alert>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <Alert className="mt-3">
                            <Info className="h-4 w-4" />
                            <AlertDescription>
                                <strong>Role:</strong> Select and merge Single
                                Proofs into blocks, similar to Ethereum's block
                                builders.
                                <br />
                                <strong>Revenue:</strong> Earn 0.02 NPT per
                ...
                <Card>
                    <CardHeader>
                        ...
                        <Alert className="mt-3">
                            <Info className="h-4 w-4" />
                            <AlertDescription>
                                <strong>Role:</strong> Solve proof-of-work
                                puzzles using ASICs, GPUs, or mining hardware.
                                <br />
                                <strong>Revenue:</strong> Earn block rewards
                                plus all transaction fees from composed blocks.
                            </AlertDescription>
                        </Alert>
                    </CardHeader>
                    <CardContent className="space-y-4">
