        ...
        <Card>
          ...
          <CardContent className="space-y-4">
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Enable upgrading of transaction proofs
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Transaction Upgrade Filter</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      value={field.value ?? ''}
                      ...
                      onChange={(e) => {
                        ...
                        handleFieldChange('txUpgradeFilter', e.target.value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Filter for which transactions to upgrade (optional)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        field.onChange(value);
                        handleFieldChange('gobblingFraction', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Fraction of block space for gobbling (0-1)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseFloat(e.target.value);
                        field.onChange(value);
                        handleFieldChange('minGobblingFee', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                ...
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  ...
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleFieldChange('compose', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        field.onChange(value);
                        handleFieldChange('maxNumComposeMergers', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Maximum number of concurrent compose mergers
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Keep block compositions secret until found
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleFieldChange('secretCompositions', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Ignore block compositions from other miners
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleFieldChange('ignoreForeignCompositions', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
          ...
          <CardContent className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Guessing</FormLabel>
                    <FormDescription>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        const value = e.target.value
                          ...
                          : undefined;
                        field.onChange(value);
                        handleFieldChange('guesserThreads', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Number of threads for guessing (optional, defaults to CPU
                    count)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseFloat(e.target.value);
                        field.onChange(value);
                        handleFieldChange('guesserFraction', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Minimum Guesser Fraction</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      step="0.01"
                      ...
                      onChange={(e) => {
                        const value = Number.parseFloat(e.target.value);
                        field.onChange(value);
                        handleFieldChange('minimumGuesserFraction', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Minimum Guesser Improvement Fraction</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      step="0.01"
                  ...
                  <FormDescription>
                    Minimum improvement fraction for guessing (0-1)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
