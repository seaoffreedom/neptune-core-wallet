  ...
  return (
    <Form {...form}>
      <form className="space-y-6">
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        field.onChange(value);
                        handleFieldChange('peerPort', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Port for peer-to-peer connections (1-65535)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseInt(e.target.value, 10);
                        field.onChange(value);
                        handleFieldChange('rpcPort', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        handleFieldChange('peerListenAddr', e.target.value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Peer Management</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Max Peers */}
            <FormField
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseInt(e.target.value, 10);
                        field.onChange(value);
                        handleFieldChange('maxNumPeers', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Maximum number of peer connections (0-1000)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseInt(e.target.value, 10);
                        field.onChange(value);
                        handleFieldChange('peerTolerance', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseInt(e.target.value, 10);
                        field.onChange(value);
                        handleFieldChange('reconnectCooldown', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Cooldown period before reconnection attempts (seconds,
                    0-86400)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Only connect to peers from the configured list
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleFieldChange('restrictPeersToList', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Bootstrap</FormLabel>
                    <FormDescription>
                      Enable bootstrap mode for initial peer discovery
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleFieldChange('bootstrap', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
