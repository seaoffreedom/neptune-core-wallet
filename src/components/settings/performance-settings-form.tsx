...
export function PerformanceSettingsForm({
    ...
    return (
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Proof Configuration</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Max Log2 Padded Height for Proofs</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      min="10"
                  ...
                  <FormDescription>
                    Maximum log2 padded height for proofs (10-32, optional)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Maximum Number of Proofs</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      min="1"
                      ...
                      onChange={(e) => {
                        ...
                        field.onChange(value);
                        handleFieldChange('maxNumProofs', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Triton VM Environment Variables</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      value={field.value ?? ''}
                      ...
                      onChange={(e) => {
                        ...
                        handleFieldChange('tritonVmEnvVars', e.target.value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Environment variables for Triton VM (optional,
                    comma-separated)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        const value = Number.parseInt(e.target.value, 10);
                        field.onChange(value);
                        handleFieldChange('syncModeThreshold', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Block height difference threshold for sync mode (10-100000)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        field.onChange(e.target.value);
                        handleFieldChange('maxMempoolSize', e.target.value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Maximum mempool size (format: 1G, 500M, 100K)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Transaction Proving Capability</FormLabel>
                  <Select
                    onValueChange={(value) => {
                      field.onChange(value);
                      handleFieldChange('txProvingCapability', value);
                    }}
                    value={field.value}
                  >
                    <FormControl>
                    ...
                    <SelectContent>
                      <SelectItem value="lockscript">Lockscript</SelectItem>
                      <SelectItem value="singleproof">Single Proof</SelectItem>
                  ...
                  <FormDescription>
                    Transaction proving capability level (optional)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Number of MPS per UTXO</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      min="1"
                      ...
                      onChange={(e) => {
                        const value = Number.parseInt(e.target.value, 10);
                        field.onChange(value);
                        handleFieldChange('numberOfMpsPerUtxo', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
