  ...
  return (
    <Form {...form}>
      <form className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Disable display of cookie hint on startup
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        ...
                        handleFieldChange('disableCookieHint', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Prevent initiation of new transactions
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleFieldChange('noTransactionInitiation', value);
                      }}
                    />
                  </FormControl>
                </FormItem>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Fee Notification</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <FormField
              control={form.control}
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Scanning & Monitoring</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Scan Blocks */}
            <FormField
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        handleFieldChange('scanBlocks', e.target.value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
                    Block ranges to scan (optional, e.g., 0-100,200-300)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        const value = e.target.value
                          ...
                          : undefined;
                        field.onChange(value);
                        handleFieldChange('scanKeys', value);
                      }}
                    />
                  </FormControl>
                  <FormDescription>
