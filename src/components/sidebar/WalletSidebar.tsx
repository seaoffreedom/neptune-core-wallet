              ...
              <div className="space-y-1">
                      ...
                      {isLoading ? (
                        ...
                        <span className="font-mono text-warning">
                          ...
                          <span className="text-xs ml-1">
                            ({dashboardData?.mempool_own_tx_count || 0} pending
                            transaction
                            {dashboardData?.mempool_own_tx_count !== 1
                              ? 's'
                              : ''}
                            )
                          </span>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  {utxos.length === 0 ? (
                    ...
                    <span className="font-mono">
                      {utxos.length} {utxos.length === 1 ? 'coin' : 'coins'}
                    </span>
                  )}
                </div>
              </div>
                        ...
                        <div className="text-right">
                          <div className="font-mono">
                            {new Intl.NumberFormat('en-US', {
                              style: 'currency',
                              currency: priceFetchingSettings.currency,
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  {isLoading ? (
                    ...
                    <span>{dashboardData?.peer_count || peerInfo.length}</span>
                  )}
                </div>
                <div className="flex justify-between">
