...
export function MempoolOverviewCompact({
  ...
  const handleCopyTxId = async (txId: string) => {
    try {
      ...
      logger.error('Failed to copy transaction ID', {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {recentTransactions.length > 0 ? (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-medium">Transactions in Mempool</h4>
                      ...
                      <TableRow key={tx.id} className="group hover:bg-muted/50">
                        ...
                        <TableCell>
                          ...
                          >
                            ...
                            />
                            {tx.synced === true ? 'Synced' : 'Unsynced'}
                          </Badge>
                        </TableCell>
                        <TableCell className="text-sm">
