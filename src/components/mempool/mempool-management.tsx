    ...
    const handleBroadcastAll = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                toast.error(
                    `Failed to broadcast transactions: ${result.error}`,
                );
            }
        } catch (error) {
            toast.error(
    ...
    const handleClearMempool = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                toast.error(`Failed to clear mempool: ${result.error}`);
            }
        } catch (error) {
            toast.error(`Error clearing mempool: ${(error as Error).message}`);
        } finally {
            setIsClearing(false);
        }
    };
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    ...
                                    transactions from the mempool? This action
                                    cannot be undone and will remove {txCount}{" "}
                                    pending transaction
                                    {txCount !== 1 ? "s" : ""}.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
