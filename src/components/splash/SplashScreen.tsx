      ...
      try {
        ...
        if (status?.success && status.status) {
          ...
          if (
            ...
            try {
              console.log('🔄 Fetching cookie from process manager...');
            ...
            setIsReady(true);
            console.log('⏱️  Waiting 1 second before calling onReady()...');

            setTimeout(() => {
              console.log('✅ Calling onReady() - transitioning to main app');
              onReady();
            }, 1000);
          }
        }
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">Neptune Core</span>
              </div>
              <Badge
                variant="outline"
              ...
              >
                ...
                <span className="ml-1 capitalize">{coreStatus.status}</span>
              </Badge>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">Neptune CLI</span>
              </div>
              <Badge
                variant="outline"
              ...
              >
                ...
                <span className="ml-1 capitalize">{cliStatus.status}</span>
              </Badge>
            </div>
          </div>
