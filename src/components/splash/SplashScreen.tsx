...
export function SplashScreen({ onReady }: SplashScreenProps) {
  ...
  const getThemeClasses = () => {
    switch (theme) {
      ...
      case 'nautical':
        return {
          background: 'bg-gradient-to-br from-slate-950 via-slate-950 to-black',
          ...
          if (
            ...
            try {
              ...
              if (typeof cookieResult === 'string') {
                ...
                if (wrappedResult.success && wrappedResult.cookie) {
                  // Wrapped response
      ...
      <div className="relative z-10 w-full max-w-lg space-y-12">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            >
              <span>Loading</span>
              <span className={`font-mono ${themeClasses.textPrimary}`}>
                {progress}%
              </span>
            </div>
            <div className="relative">
