...
export const utxoColumns: ColumnDef<UTXO>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="font-mono font-semibold">{amount.toFixed(2)} $NPT</div>
      );
    },
    sortingFn: (rowA, rowB) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="text-sm text-muted-foreground">{ageText}</span>;
    },
  },
  {
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem
              onClick={() => {
                ...
                showSuccessToast('Amount copied to clipboard');
              }}
            >
