                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p className="max-w-xs">
                                        You have many small UTXOs. Consolidating
                                        them into fewer, larger UTXOs can reduce
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    {summary.unconfirmedCount > 0 && (
                        <div className="space-y-1">
                            ...
                            <div className="space-y-1">
                                <div className="text-xs text-muted-foreground font-mono">
                                    {formatBalance(summary.unconfirmedValue)}{" "}
                                    $NPT
                                </div>
                                <PriceDisplay
                    ...
                    {summary.timeLockedCount > 0 && (
                        <div className="space-y-1">
                            ...
                            <div className="space-y-1">
                                <div className="text-xs text-muted-foreground font-mono">
                                    {formatBalance(summary.timeLockedValue)}{" "}
                                    $NPT
                                </div>
                                <PriceDisplay
