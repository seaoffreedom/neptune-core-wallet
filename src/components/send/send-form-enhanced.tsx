        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>• Your transaction has been created and stored locally</p>
              <p>
                • It will be broadcast to the network when your node connects to
                peers
              </p>
              <p>• Keep your node running to ensure proper broadcast</p>
                    ...
                    <FormField
                      ...
                      render={({ field: addressField }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Enter address or select from address book
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                        ...
                        <FormItem>
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              ...
                              disabled={
                                !confirmedBalance || calculateMaxAmount() <= 0
                              }
                          ...
                          <FormControl>
                            <InputGroup>
                              <InputGroupInput
                                ...
                                {...amountField}
                              />
                              <InputGroupText>$NPT</InputGroupText>
                            </InputGroup>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                ...
                >
                  {isSending || isValidating ? (
                    <>
                      ...
                      {isValidating ? 'Validating...' : 'Sending...'}
                    </>
                  ) : (
                    <>
                      Send Transaction
          ...
          {pendingTransaction && (
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {pendingTransaction.recipients.map((recipient, index) => (
                  <div
                  ...
                  >
                    ...
                    <div className="ml-4 text-right">
                      <div className="font-mono font-medium">
                        {parseFloat(recipient.amount).toFixed(2)} NPT
                      </div>
                      <PriceDisplay
                        nptAmount={parseFloat(recipient.amount)}
                        className="text-xs"
                      />
                    </div>
                  </div>
              ...
              {pendingTransaction.fee && (
                <div className="flex justify-between items-center p-3 bg-muted/50 rounded-lg">
                  ...
                  <span className="font-mono text-sm">
                    {parseFloat(pendingTransaction.fee).toFixed(2)} NPT
                  </span>
                </div>
              )}
              ...
              <div className="flex items-center space-x-2 p-3 bg-destructive/10 rounded-lg border border-destructive/20">
                ...
                >
                  I confirm that I want to send this transaction
                </label>
              </div>
            </div>
          )}
