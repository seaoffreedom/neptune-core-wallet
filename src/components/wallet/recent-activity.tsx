...
export function RecentActivity({
  ...
  const getStatus = (
    ...
    return txConfirmations >= requiredConfirmations ? 'confirmed' : 'pending';
  };
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      type === 'received' ? 'bg-green-500/10' : 'bg-blue-500/10'
                    )}
                  >
                    {type === 'received' ? (
                  ...
                  <div
                    className={cn(
                      ...
                      type === 'received' ? 'text-green-500' : 'text-foreground'
                    )}
                  >
                    {type === 'received' ? '+' : ''}
