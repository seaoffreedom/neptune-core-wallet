...
export const IPC_CHANNELS = {
  ...
  // Direct CLI commands
  CLI_GET_PEER_INFO: 'cli:get-peer-info',
  ...
  SYSTEM_HAS_SUFFICIENT_RAM_FOR_MINING: 'system:has-sufficient-ram-for-mining',
  ...
  BLOCKCHAIN_BROADCAST_ALL_MEMPOOL_TXS: 'blockchain:broadcast-all-mempool-txs',
  BLOCKCHAIN_CLEAR_MEMPOOL: 'blockchain:clear-mempool',
  BLOCKCHAIN_GET_MEMPOOL_TX_KERNEL: 'blockchain:get-mempool-tx-kernel',
  BLOCKCHAIN_GET_SYNC_STATUS: 'blockchain:get-sync-status',
  BLOCKCHAIN_GET_NETWORK_INFO: 'blockchain:get-network-info',
  BLOCKCHAIN_GET_PEER_INFO: 'blockchain:get-peer-info',
  BLOCKCHAIN_GET_BALANCE: 'blockchain:get-balance',
  BLOCKCHAIN_GET_BLOCK_DIFFICULTIES: 'blockchain:get-block-difficulties',
  BLOCKCHAIN_GET_BLOCK_INTERVALS: 'blockchain:get-block-intervals',
  ...
  BLOCKCHAIN_GET_BEST_PROPOSAL: 'blockchain:get-best-proposal',
  BLOCKCHAIN_MINE_BLOCKS_TO_WALLET: 'blockchain:mine-blocks-to-wallet',
  BLOCKCHAIN_PROVIDE_POW_SOLUTION: 'blockchain:provide-pow-solution',
  BLOCKCHAIN_PROVIDE_NEW_TIP: 'blockchain:provide-new-tip',
  ...
  NEPTUNE_SETTINGS_UPDATE_PRICE_FETCHING:
    'neptune-settings:update-price-fetching',
