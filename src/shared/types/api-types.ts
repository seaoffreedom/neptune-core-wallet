...
// Mempool transaction information from Neptune Core
...
export interface ElectronAPI {
  ...
  blockchain: {
    ...
    getMempoolOverview: (params: {
      ...
      success: boolean;
      transactions?: MempoolTransactionInfo[];
      error?: string;
    }>;
    ...
    getBestProposal: () => Promise<{
      success: boolean;
      proposal?: unknown;
      error?: string;
    }>;
    mineBlocksToWallet: (params: { n_blocks: number }) => Promise<{
      success: boolean;
      result?: string;
      error?: string;
    }>;
    providePowSolution: (params: {
      pow: unknown;
      proposal_id: unknown;
    }) => Promise<{
      success: boolean;
