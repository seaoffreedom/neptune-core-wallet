...
<div style="display: flex; align-items: center; gap: 10px; margin: 10px 0;">
  ...
  <button onclick="navigator.clipboard.writeText('neptune1...')" style="background: #007acc; color: white; border: none; padding: 8px 12px; border-radius: 4px; cursor: pointer; font-size: 12px;">
    📋 Copy
  </button>
</div>
